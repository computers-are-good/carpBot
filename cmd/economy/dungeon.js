...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName("dungeon").setDescription("Which dungeon to enter?").setRequired(true)),
    async execute(interaction) {
        ...
        if (!dungeonFound) {
            await interaction.reply("That dungeon is not found. See the available dungeons with `/dungeonlist`");
            return;
        }
